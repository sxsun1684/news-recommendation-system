...
# user_id = db.create_user("cc1@neu.edu", "mypassword123", ["Tech", "Finance"])
#
# # Test user login (password verification)
# db.authenticate_user("cc1@neu.edu", "123")  # ✅ Correct password
# db.authenticate_user("cc1@neu.edu", "wrongpassword")  # ❌ Incorrect password
